...
# ZealOS does not auto-mount the shuttle on first boot — we have to attach
# it explicitly. Same block that Setup.ZC writes into ~/MakeHome.ZC for
# subsequent boots. Sleep gives AHCI a moment before we read the FAT.
